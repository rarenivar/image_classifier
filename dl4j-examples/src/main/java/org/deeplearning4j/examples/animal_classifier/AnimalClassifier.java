        ...
        for (int i = 0; i < epochValues.length; i++) {
            for (int j = 0; j < iterationValues.length; j++) {
                for (int k = 0; k < learningRateValues.length; k++) {
                    ...
                    InputSplit trainInputSplit = getTrainingData("user.dir", "dl4j-examples/src/main/resources/animals",
                        parentPathLabelGenerator);
                    InputSplit testInputSplit = getTestData("user.dir", "dl4j-examples/src/main/resources/animals",
                        parentPathLabelGenerator);
